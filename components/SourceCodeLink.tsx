...
export default function SourceCodeLink() {
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="inline-flex items-center gap-2 rounded-lg border border-white/10 px-3 py-2 text-sm text-neutral-300 transition hover:bg-white/5 hover:text-neutral-100"
    >
      <svg
        aria-hidden="true"
        viewBox="0 0 16 16"
